...
<html lang="en">
    ...
    <body>
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to E-COFFEE SYSTEM.</h3>
                <p>
                    <strong>We are open 24/7.</strong>
                </p>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    <h3>Welcome to E-COFFEE SYSTEM</h3>
                    <p>
                        At E-COFFEE SYSTEM, we are passionate about coffee and believe
                        that every cup tells a story. 
                    </p>
                    <p>
