...
<html lang="en">
    ...
    <body>
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to E-COFFEE SYSTEM, <?php echo $_SESSION['username']; ?>!</h3>
                <p>
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    ...
                    <p>
                        ...
                        inviting atmosphere at E-COFFEE SYSTEM is designed to be a haven
                        for coffee lovers.
                    </p>
